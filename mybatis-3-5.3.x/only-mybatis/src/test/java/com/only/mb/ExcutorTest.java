...
public class ExcutorTest {
    ...
    public void simple() throws SQLException {
        ...
        MappedStatement mappedStatement = configuration.getMappedStatement("com.only.mapper.UserMapper.selectById");
    ...
    public void batch() throws SQLException {
        ...
        MappedStatement mappedStatement = configuration.getMappedStatement("com.only.mapper.UserMapper.updateForName");
